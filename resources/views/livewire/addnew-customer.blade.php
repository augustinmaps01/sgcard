<div class="sm:ml-64">
    <div class="container bg-white shadow-3xl mb-28">
        {{-- <div id="" class="p-4">
            ...
            @if (session('success'))
                <div x-data = "{open: true}" id="targetElement" class="p-4">
                    <div  x-show = "open" class="flex items-center p-2 mt-4 text-center text-white bg-green-600 border border-green-600 rounded-lg shadow-lg" role="alert">
        ...
        <div class="flex justify-center w-full px-5 py-2 mx-auto mb-10">
            <form id ="dateForm" wire:submit.prevent ="save">
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input type="text" x-model = "amount"  wire:model.live.debounce.200ms = "amountOpened" x-mask:dynamic = "$money($input, '.' )" id="currency-input" name ="amount_open" autocomplete="off"
                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                        placeholder="" required />
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    ...
                    <div class="relative z-0 w-full mb-5 group">
                        <input type="text" wire:model.live.debounce.200ms = "suffix" name="suffix" id="suffix" autocomplete="off"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" " />
                            @error('suffix')
                            <span class="text-red-800 text-[12px] font-normal font-sans"> {{ $message }}</span>
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <label for="countries" class="block mb-2 text-sm font-medium text-gray-900">Select an
                        option</label>
                    <select id="countries" name = "branch" wire:model.live.debounce.200ms = "brid"

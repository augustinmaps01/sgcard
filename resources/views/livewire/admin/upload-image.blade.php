<div class="py-4 mb-24 sm:ml-64">
    {{-- Success is as dangerous as failure. --}}
        ...
        <div class="container p-6 mx-auto text-center bg-white">
            ...
            @if (session('success'))
                <div x-data="{ isVisible: true }" id="targetElement" class="w-1/2 p-4 mx-auto">
                    <div x-show="isVisible" x-init="setTimeout(() => isVisible = false, 5000)" class="flex items-center justify-center p-2 mt-4 text-center text-white bg-green-600 border border-green-600 rounded-lg shadow-lg" role="alert">
                        ...
                        <button @click="isVisible = false" id="triggerElement" type="button" class="ml-auto -mx-1.5 -my-1.5 bg-green-50 text-gray-200 rounded-lg focus:ring-2 focus:ring-green-400 p-1.5 hover:bg-green-200 inline-flex items-center justify-center h-8 w-8 dark:bg-gray-800 dark:text-green-400 dark:hover:bg-gray-700" aria-label="Close">
            ...
            <form  wire:submit.prevemt = "store">
                <div class="container grid grid-cols-1 gap-4 mx-auto mt-8 md:grid-cols-2">
                    ...
                    <div class="p-4 rounded">
                        <div class="container mx-auto mt-8 text-center">
                            ...
                            <input
                                class="block w-full mb-2 text-lg border border-blue-300 rounded-lg cursor-pointer text-white-900 dark:text-blue-4 focus:outline-none dark:blue-400"
                                id="compress" name="dpr_back" wire:model.live = "dpr_front" accept="image/*" type="file">
                            @error('dpr_front')
                                <span class="text-red-800 text-[12px] font-normal font-sans"> {{ $message }}</span>
                            @enderror
                            @if($dpr_front)

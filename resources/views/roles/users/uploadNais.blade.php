                    ...
                    <div class="px-4 py-6">
                        <div id="image-preview"
                            ...
                            <label for="upload" class="cursor-pointer">
                                ...
                                <h5 class="mb-2 text-xl font-bold tracking-tight text-gray-700">Upload Front NAIS
                                </h5>
                    ...
                    <div class="px-4 py-6">
                        <div id="image-preview"
                            ...
                            <label for="upload" class="cursor-pointer">
                                ...
                                <h5 class="mb-2 text-xl font-bold tracking-tight text-gray-700">Upload Back NAIS
                                </h5>
                                <span id="filename" class="text-gray-500 bg-gray-200 z-50"></span>
                            </label>
                        </div>

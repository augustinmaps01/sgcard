                    ...
                    <div class="px-4 py-6">
                        <div id="image-preview"
                            ...
                            <label for="upload" class="cursor-pointer">
                                ...
                                <h5 class="mb-2 text-xl font-bold tracking-tight text-gray-700">Upload Front Data
                                    Privacy
                                </h5>
                    ...
                    <div class="px-4 py-6">
                        <div id="image-preview"
                            ...
                            <label for="upload" class="cursor-pointer">
                                ...
                                <h5 class="mb-2 text-xl font-bold tracking-tight text-gray-700">Upload Back Data privacy
                                </h5>
                                <span id="filename" class="text-gray-500 bg-gray-200 z-50"></span>
                            </label>
                        </div>
...
>>>>>>> 7cbd2231f9250c177a181e4648b974ed7944a7d8
</body>
